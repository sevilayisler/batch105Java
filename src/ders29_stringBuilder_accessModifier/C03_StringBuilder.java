...
public class C03_StringBuilder {
    ...
    public static void main(String[] args) {
        ...
        // Ayni not Integer,Byte ve Short gibi sayi barindiran
        // non-primitive'ler icin de gecerlidir
        // sb guzel kelimesi iceriyor mu ?
        /*
          StringBuilder'da olmayan, String class'inda
            bulunan method'lari kullanmak isterseniz
