...
public class C06_WhileLoop {
        ...
        /*
        Soru : Kullanicidan sifre isteyin asagidaki sartlari
          saglamayan sifrelerde hatalari yazdirip,
         ...
         */
            ...
            while(sifreGecerliMi!=true){
                ...
                if (!(sifre.charAt(sifre.length()-1)>='0' &&
                        sifre.charAt(sifre.length()-1)<='9' )){
