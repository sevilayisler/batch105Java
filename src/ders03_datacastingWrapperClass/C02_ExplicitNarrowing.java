...
public class  C02_ExplicitNarrowing {
    ...
    public static void main(String[] args) {
        ...
        /*
          ...
          ancak bu durumda data kayiplari (double'den
           int'e gecerken virgulden sonrasi silinir)
          veya baskalasim olabilir (int'i byte cevirirsek
           tekrar tekrar basa doner)
         */
        short sh = (short) sayi;
